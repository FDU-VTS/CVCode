...
def gaussian_filter_density(gt):
    ...
    for i, pt in enumerate(pts):
        ...
        print(np.sum(pt2d), np.sum(scipy.ndimage.filters.gaussian_filter(pt2d, sigma, mode='constant')))
    print('done.')
    return density
...
img_path = os.path.join(test_path, "img_0001.jpg")
mat = io.loadmat(img_path.replace('.jpg','_ann.mat'))
# img_path = "../../data/shtu_dataset/original/part_A_final/train_data/images/IMG_1.jpg"
