...
"""
 ...
 model: mcnn | csr_net | sa_net | tdf_net
...
def train(zoom_size=4, model="mcnn", dataset="shtu_dataset"):
    ...
    if dataset == "shtu_dataset":
        ...
        tech_loader = torch.utils.data.DataLoader(mall_data, batch_size=4, shuffle=True, num_workers=4)
        print("test data loading............")
        mall_test_data = mall_data
        test_loader = torch.utils.data.DataLoader(mall_test_data, batch_size=4, shuffle=False, num_workers=4)
    ...
    for epoch in range(2000):
        ...
        if epoch % 2 == 0:
            ...
            if sum_mae / len(test_loader) < min_mae:
                ...
                torch.save(net.state_dict(), "./model/mall_result/mcnn.pkl")
    ...
    try:
        np.save("./model/mall_result/mcnn.npy", result)
    except IOError:
        os.mkdir("./model")
        np.save("./model/mall_result/mcnn.npy", result)
