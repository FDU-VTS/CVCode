...
net = csr_net.CSRNet()
# net.load_state_dict(torch.load("./models/csr_net/best_csr_net_4.pkl", map_location='cpu'))
net.load_state_dict(torch.load("./models/csr_net/best_csr_net_1.pkl"))
net = net.to(DEVICE)
net = net.eval()
sum_mae = 0.0
sum_mse = 0.0
...
save_path = "./results/"
for index, (input, ground_truth) in enumerate(test_loader):
